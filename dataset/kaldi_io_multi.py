...
class FeatureReader(object):
    ...
    def __init__(self, data):
        ...
        self.slabel_dim = self.get_slabel_dim()
        self.utt2num_frames = {}
    ...
    def get_xvector_dim(self):
        ...
        return xvector_dim
    def get_slabel_dim(self):
        with open(os.path.join(self.data, "slabel.scp"), "r") as f:
            slabel_dim = self.read_xvector(f.readline().strip()).shape[1]
        return slabel_dim
    def close(self):
        for name in self.fd:
            self.fd[name].close()
