...
class Trainer(object):
    ...
    def build_ori(self, mode, dim, loss_type=None, num_speakers=None, noupdate_var_list=None):
        """ Build a network.
    ...
    def build(self, mode, dim, loss_type=None, num_speakers=None, noupdate_var_list=None):
        ...
        self.train_features = tf.placeholder(tf.float32, shape=[None, None, dim], name="train_features")
        self.train_labels = tf.placeholder(tf.int32, shape=[None, ], name="train_labels")
        self.train_xvectors = tf.placeholder(tf.float32, shape=[None, 512], name="train_xvectors")
        self.train_slabel = tf.placeholder(tf.float32, shape=[None, 154], name="train_slabel")
