...
if (@ARGV != 2) {
  ...
  print STDERR "e.g. $0 /export/corpora5/SRE/SRE2016/eval/ data/\n";
  exit(1);
}
...
%seg2sph = ();
open(TRIALS, "<$db_base/docs/sre16_eval_trial_key.tsv") || die "Could not open $db_base/docs/sre16_eval_trial_key.tsv";
open(TRAIN, "<$db_base/docs/sre16_eval_enrollment.tsv") || die "Could not open $db_base/docs/sre16_eval_enrollment.tsv";
