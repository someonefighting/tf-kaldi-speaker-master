...
local/make_sre.pl $data_root/SRE04/ \
   04 $sre_ref $data_dir/sre2004

local/make_sre.pl $data_root/SRE05/r101_1_1/train/ \
  05 $sre_ref $data_dir/sre2005_train

local/make_sre.pl $data_root/SRE05/r101_1_1/test/ \
  05 $sre_ref $data_dir/sre2005_test

local/make_sre.pl $data_root/SRE06/r108_1_1/train/ \
  06 $sre_ref $data_dir/sre2006_train

local/make_sre.pl $data_root/SRE06/r108_1_1/test/ \
