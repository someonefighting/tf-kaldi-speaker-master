...
root=/liry_tf/tf-kaldi-speaker/egs/voxceleb/v1
data=$root/data
...
nnet/run_train_nnet_eftdnn.sh --cmd "$cuda_cmd" --env tf_2_gpu --continue-training true nnet_conf/tdnn_amsoftmax_m0.15_linear_bn_1e-2.json \
    $data/voxceleb_train_combined_no_sil/train2 $data/voxceleb_train_combined_no_sil/train2/spklist \
    $data/voxceleb_train_combined_no_sil/valid2 $data/voxceleb_train_combined_no_sil/train2/spklist \
    $nnetdir
#
# nnetdir=$exp/xvector_nnet_tdnn4_asoftmax_m4_linear_bn_1e-2.json
# nnet/run_train_nnet_eftdnn.sh --cmd "$cuda_cmd" --env tf_2_gpu --continue-training true nnet_conf/tdnn4_asoftmax_m4_linear_bn_1e-2.json \
#     $data/voxceleb_train_combined_no_sil/train2 $data/voxceleb_train_combined_no_sil/train2/spklist \
#     $data/voxceleb_train_combined_no_sil/valid2 $data/voxceleb_train_combined_no_sil/train2/spklist \
#     $nnetdir
#
