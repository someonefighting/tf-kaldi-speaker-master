...
open(KEY, "<${db_base}/docs/sre18_eval_trials.tsv") || die "Could not open trials file $db_base/docs/sre18_eval_trials.tsv.  It might be located somewhere else in your distribution.";
