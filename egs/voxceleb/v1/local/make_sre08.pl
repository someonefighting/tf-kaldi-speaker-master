...
%seg2sph = ();
open(TRIALS, "</liry_tf/data/SRE19/SRE08/sp08-11/doc/02_source/trial-keys/NIST_SRE08_short2-short3.trial.key") || die "Could not open /mnt/workspace/project/SRE18/SRE08/sp08-11/doc/02_source/trial-keys/NIST_SRE08_short2-short3.trial.key";
open(MODELS, "</liry_tf/data/SRE19/SRE08/sp08-11/doc/02_source/model-keys/NIST_SRE08_short2.model.key") || die "Could not open /mnt/workspace/project/SRE18/SRE08/sp08-11/doc/02_source/model-keys/NIST_SRE08_short2.model.key";
