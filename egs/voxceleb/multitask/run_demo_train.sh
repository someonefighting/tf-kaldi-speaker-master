...
#    $nnetdir
#
#for alpha in {4..10};do
alpha=DLKD
nnetdir=$exp/$alpha/xvector_nnet_tdnn_asoftmax_m4_linear_bn_1e-2
nnet/run_train_nnet_multitask.sh --cmd "$cuda_cmd" --env tf_2_gpu --continue-training false nnet_conf/tdnn_multitask_${alpha}.json \
    $data/voxceleb_train_combined_no_sil/train2 $data/voxceleb_train_combined_no_sil/train2/spklist \
